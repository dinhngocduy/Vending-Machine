    ...
    <div className="product-statistic-ctn">
      ...
      <div className="product-statistics-body">
        ...
        <div className="right-component">
          ...
          <div className="row">
            {renderCardStatistic("Đồ ăn", 16280, "#F5A623")}
            {renderCardStatistic("Đồ uống", 16280, "#03BD5B")}
          </div>
          <div className="row">
            {renderCardStatistic("Đồ chơi", 15070, "#4A90E2")}
            {renderCardStatistic("Đồ ăn vặt", 15070, "#FF2D54")}
          </div>
        </div>
      </div>
    </div>
