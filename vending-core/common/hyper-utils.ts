...
export let HyperUtils = {
  ...
  getAvatar: function (guid: string) {
    const id = guid || '';
    console.log('test_get_avatar...');
    return APP_CONFIGS.SERVER_FILE_AVATAR + id;
  },

  checkLink: function (str: string) {
  ...
  getUserName: function (userInfo?: User2) {
    var userName;
